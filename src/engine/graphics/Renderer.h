...
namespace voidx {
    ...
    public:
        ...
        static void DrawQuad(GLuint textureID, const glm::vec2& position, const glm::vec2& size, float rotation = 0.0f, const glm::vec4& color = {1,1,1,1}, const glm::vec2& pivot = {0.5f, 0.5f}, bool flipX = false, bool flipY = false);
        static void DrawQuadUV(GLuint textureID, const glm::vec2& position, const glm::vec2& size, const glm::vec2 uv[4], const glm::vec4& color, const glm::vec2& pivot = {0.0f, 0.0f}, float rotation = 0.0f, bool flipX = false, bool flipY = false);
    ...
    private:
        ...
        static std::vector<int> s_Samplers;
